<x-layout>
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    ...
    <form method="POST" action="{{ route('update', $listing) }}" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="mb-6">
      ...
      <div class="mb-6">
        ...
        <img class="w-48 mr-6 mb-6"
          src="{{$listing->logo ? asset('/images/logos/' . $listing->logo) : asset('/images/no-image.png')}}" alt="" />
      ...
      <div class="mb-6">
        <button class="bg-cyan-700 text-white rounded py-2 px-4 hover:bg-black">
          Update Gig
        </button>
